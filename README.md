...
## Contributions
Notice a bug? [Open an issue!](https://github.com/Traewelcross/Traewelcross/issues/new) \
Would you like to see a feature implemented? [Also open an issue!](https://github.com/Traewelcross/Traewelcross/issues/new) \
You are of couse also welcome to open PRs and contribute code directly :).